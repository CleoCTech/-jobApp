                                ...
                                <div class="step wizard-step mybox" data-state="branchtype">
                                    ...
                                    <div class="form-group">
                                        <label class="custom">Referee Details
                                            <input type="text" name="name" id="id" style="width:400px !important;"
                                        ...
                                        <button onclick="addReferees()" type="button" name="add" class="forward">Add
                                            Others+</button>
                                        <hr>
                                        <!-- <div id="myDIV4" style="display: none;">
                                            <label class="custom">Referee Details
                                                ...
                                                <input type="text" name="company" id="id"
                                                    ...
                                                    class="form-control required fl-input" placeholder="Community Name">
                                                <br>
                                                <input type="text" name="position" id="id"
                                                    style="width:400px !important;"
                                                    class="form-control required fl-input" placeholder="Position">
                                                <br>
